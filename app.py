...
if df.empty:
    ...
    with col_a:
        st.page_link("pages/1_Insights_Keuangan.py",          label="📈 Lihat Insights Lengkap →")
    with col_b:
        st.page_link("pages/3_Prediksi.py",           label="🔮 Lihat Prediksi Keuangan →")
    with col_c:
        st.page_link("pages/4_AI_Advisor.py",         label="💬 Chat dengan AI Advisor →")
